...
*/
serverCommandPassword = "codah7676";
...
{
	{
		{"76561198044866508","UID2","UID3","..."},	/* Admins with UIDs in this Array have their Access defined in the array below. */
		{
...
blacklistedVariables[] =
{
	...
	"sni_prz_zzz_targetplayer","healit","o_fnc_arma","mlrn_exec","running_threads","catchemall16555","killtarget","gmtoggle","t1","fuck_me_keyp","cheatcurator"
};
