...
UPDATEEMAIL='dadoprso76@gmail.com';
INFISTARVERSION='07-12-2018 23-59-49 - v93';
...
diag_log format['<infiSTAR.de> %1 - VERSION: 07-12-2018 23-59-49 - v93',time];
{
	_x params ['_uids'];
	{
		private _uid = _x;
...
if!(isClass (missionconfigfile >> 'RscListBox_infiSTAR'))exitWith{
	_log = format['<infiSTAR.de> %1 - infiSTAR_defines.hpp is not in your MPMission or you forgot to #include it within your description.ext   [33076x2 - 07-12-2018 23-59-49 - v93 - %2 - %3]',time,serverName,productVersion];
	diag_log _log;
	['MPMission_ERROR',_log] call FNC_A3_CUSTOMLOG;
};
if!(isClass (missionconfigfile >> 'infiSTAR_AdminMenu'))exitWith{
	_log = format['<infiSTAR.de> %1 - infiSTAR_AdminMenu.hpp is not in your MPMission or you forgot to #include it within your description.ext   [33076x2 - 07-12-2018 23-59-49 - v93 - %2 - %3]',time,serverName,productVersion];
	diag_log _log;
	['MPMission_ERROR',_log] call FNC_A3_CUSTOMLOG;
};
if!(isClass (missionconfigfile >> 'infiSTAR_CHAT'))exitWith{
	_log = format['<infiSTAR.de> %1 - infiSTAR_chat.hpp is not in your MPMission or you forgot to #include it within your description.ext   [33076x2 - 07-12-2018 23-59-49 - v93 - %2 - %3]',time,serverName,productVersion];
	diag_log _log;
	['MPMission_ERROR',_log] call FNC_A3_CUSTOMLOG;
};
if!(isClass (missionconfigfile >> 'RscListBox_infiSTAR'))exitWith{
	_log = format['<infiSTAR.de> %1 - infiSTAR_KeyBinds.hpp is not in your MPMission or you forgot to #include it within your description.ext   [33076x2 - 07-12-2018 23-59-49 - v93 - %2 - %3]',time,serverName,productVersion];
	diag_log _log;
	['MPMission_ERROR',_log] call FNC_A3_CUSTOMLOG;
};
if!(getNumber(missionconfigfile >> 'infiSTAR_AdminMenu' >> 'version') isEqualTo 3)exitWith{
	_log = format['<infiSTAR.de> %1 - infiSTAR_AdminMenu.hpp in your MPMission is outdated. Update it or infiSTAR will not load.   [33076x2 - 07-12-2018 23-59-49 - v93 - %2 - %3]',time,serverName,productVersion];
	diag_log _log;
	['MPMission_ERROR',_log] call FNC_A3_CUSTOMLOG;
};
...
if(!("https://*" in _allowedHTMLLoadURIs) || !("http://*" in _allowedHTMLLoadURIs))exitWith{
	_log = format["<infiSTAR.de> %1 - infiSTAR_defines.hpp in your MPMission is outdated. Update it or infiSTAR will not load.   [33076x2 - 07-12-2018 23-59-49 - v93 - %2 - %3]",time,serverName,productVersion];
	diag_log _log;
	["MPMission_ERROR",_log] call FNC_A3_CUSTOMLOG;
};
...
{
	_log = format['<infiSTAR.de> %1 - call.fsm missing in your MPmission!   [33076x2 - 07-12-2018 23-59-49 - v93 - %2 - %3]',time,serverName,productVersion];
...
_fnc_RandomGen = {
	...
	_fnc_actualGen = {
		...
		_main	= ['a','7','1','f','2','3','1','8','7','3','4','6','7','b','3','b','d','d','6','a','6','d','b','0','d','d','2','9','2','7','9','f','9'];
...
_m = missionNamespace getVariable [('UPD'+'A'+'TE'+'E'+'M'+'AI'+'L'),''];_m = _m + '&cid=16538';missionNamespace setVariable [('UPD'+'A'+'TE'+'E'+'M'+'AI'+'L'),_m];
...
_bigInputArray pushBack [
	[_name,_uid,_AHKickLog,_AHKickOFF,_admins,_admin,_isNormal,_server_classes],
	{
		...
		_devLog = format['infiSTAR.de AHAT %1 - 07-12-2018 23-59-49 - v93 - server running: %2:33076x2',VERSIONCHECKRESULT,time call FN_GET_TIME_TIME];diag_log _devLog;
		"; if(!_HIDE_FROM_PLAYERS)then{ _asd = _asd + "
...
"; }; _asd = _asd + "
	...
	_log = format['%1(%2) | %3 | %4 [07-12-2018 23-59-49 - v93]',_name,_uid,_log,time call FN_GET_TIME_TIME];
